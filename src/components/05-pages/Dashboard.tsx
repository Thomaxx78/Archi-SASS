			...
			<div className="container mx-auto px-6 py-8">
				<div className="mb-8 flex items-center justify-between">
					<div>
						...
						<p className="mt-2 text-stone-600">Gérez vos événements créés et ceux auxquels vous participez</p>
					</div>
					<button
				...
				{userEvents.length === 0 && (
					<div className="rounded-xl bg-white py-16 text-center shadow-sm">
						...
						<h3 className="mb-2 text-xl font-semibold text-stone-800">Aucun événement pour le moment</h3>
						<p className="mb-6 text-stone-600">Créez votre premier événement ou rejoignez-en un existant</p>
						<button
							onClick={() => setShowCreateModal(true)}
							className="rounded-lg bg-lime-900 px-6 py-3 font-semibold text-white transition hover:bg-lime-800"
						>
